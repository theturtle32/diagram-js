...
Modeling.prototype.getHandlers = function() {
  return {
    ...
    'entries.update': require('./cmd/UpdateEntriesHandler')
  };
};
...
Modeling.prototype.updateEntries = function (entries, newEntries, entriesContainerClass,
  element, updatedProperties) {

  var context = {
    entriesContainerClass: entriesContainerClass,
    entries: entries,
  ...
  this._commandStack.execute('entries.update', context);
};

Modeling.prototype.updateParent = function(shape, parent) {
  var context = {
    shape: shape,
    parent: parent
  };

  this._commandStack.execute('parent.update', context);
};
