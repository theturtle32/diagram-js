...
Overlays.prototype._updateOverlay = function(overlay) {
  ...
  var scale = this._viewbox.scale;
  var reciprocalScale = 1 / scale;

  // update relative
  var left, top;
  if (position.left !== undefined) {
    left = position.left * reciprocalScale;
  }
  
  if (position.top !== undefined) {
    top = position.top * reciprocalScale;
  }
  ...
  if (position.right !== undefined) {
    ...
    left = reciprocalScale * position.right * -1 + width * reciprocalScale;
  }
  ...
  if (position.bottom !== undefined) {
    ...
    top = reciprocalScale * position.bottom * -1 + height * reciprocalScale;
  }
  
  setPosition(htmlContainer, left || 0, top || 0);
  
  var matrix = 'matrix(' + reciprocalScale + ',0,0,' + reciprocalScale + ',0,0)';
  htmlContainer.style.transform = matrix;
  htmlContainer.style['-ms-transform'] = matrix;
};
...
Overlays.prototype._init = function(config) {
  ...
  var updateViewbox = function(viewbox) {
    ...
    forEach(self._overlays, function(overlay) {
